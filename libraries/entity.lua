...
entitylib.removePlayer = function(plr)
	if entitylib.Playsilentnnections[plr] then
		for _, v in entitylib.Playsilentnnections[plr] do
			v:Disconnect()
		end
		table.clear(entitylib.Playsilentnnections[plr])
		entitylib.Playsilentnnections[plr] = nil
	end
...
entitylib.stop = function()
	...
	for _, v in entitylib.Playsilentnnections do
		for _, v2 in v do
			v2:Disconnect()
		end
		table.clear(v)
	...
	table.clear(entitylib.Playsilentnnections)
